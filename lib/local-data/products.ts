...
export const localProducts: Product[] = [
  {
    ...
    description:
      "Camiseta básica material pima en color . Perfecta para uso diario",
    descriptionHtml:
      "<p>Camiseta básica de algodón 100% en color blanco. Perfecta para uso diario.</p>",
    ...
    seo: {
      ...
      description:
        "Compra la mejor t-shirt básica blanca de algodón 100%. Perfecta para uso diario.",
    },
  },
];
