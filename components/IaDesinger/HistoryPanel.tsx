  ...
  const handleBuy = () => {
    if (canvasImage) {
      try {
        ...
        // 2. Guardamos el título (Prompt)
        const gen = currentProject?.generations.find(g => g.id === selectedGenerationId);
        const title = gen ? gen.prompt : currentPrompt || "Diseño Personalizado";
