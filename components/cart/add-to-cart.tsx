...
function SubmitButton({
  ...
  const buttonClasses =
    "relative flex w-full items-center justify-center rounded-full bg-[#f2cd4e] p-4 tracking-wide text-[#272512]";
    ...
    <form
      action={async (formData) => {
        ...
        if (isLocalStorageNearQuota()) {
          console.warn(
            "⚠️ localStorage is near quota. Size:",
            getAIImagesSizeFormatted(),
          );
        ...
        if (imageToSave) {
          ...
          try {
            ...
            console.log(
              "💾 Stored compressed image in localStorage with ref:",
              customImageRef,
            );
            console.log(
            ...
            try {
              ...
              alert(
                "Error: No se pudo guardar la imagen. El almacenamiento está lleno. Por favor, completa tus compras anteriores primero.",
              );
              return;
            }
          }
    ...
    >
      ...
      {isMissingAIData && (
        <p className="mt-2 text-sm text-red-500">
          Por favor genera nuevamente tu diseño en el Editor IA.
        </p>
      )}
